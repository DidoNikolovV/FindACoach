...
VALUES
-- DidoNikolov
(1, 1, '2024-09-17 16:30:00'),
(1, 4, '2024-09-17 17:15:00'),
(1, 5, '2024-09-18 12:30:00'),
(1, 4, '2024-09-18 15:30:00'),
(1, 5, '2024-09-18 18:00:00'),
(1, 1, '2024-09-26 10:30:00'),
(1, 4, '2024-09-26 15:30:00'),
(1, 5, '2024-09-27 15:00:00'),
(1, 5, '2024-09-29 9:00:00'),
(1, 4, '2024-09-29 13:30:00'),
(1, 1, '2024-09-29 16:30:00'),
(1, 4, '2024-09-30 12:00:00'),
(1, 5, '2024-09-30 18:00:00'),
(1, 4, '2024-10-27 19:30:00'),
(1, 5, '2024-10-30 16:30:00'),
...
(2, 3, '2024-09-19 18:30:00'),
(2, 2, '2024-09-19 18:30:00'),
(2, 3, '2024-09-23 18:30:00'),
(2, 2, '2024-09-23 18:30:00'),
(2, 3, '2024-09-27 09:45:00'),
(2, 2, '2024-09-29 10:30:00'),
(2, 3, '2024-09-29 13:30:00'),
(2, 3, '2024-09-30 15:30:00'),
(2, 2, '2024-09-30 18:30:00'),
(2, 2, '2024-10-02 12:00:00'),
(2, 2, '2024-10-11 15:30:00'),
(2, 2, '2024-10-14 10:00:00'),
(2, 3, '2024-10-14 15:30:00'),
(2, 2, '2024-10-23 12:30:00'),
(2, 2, '2024-10-28 10:30:00'),
(2, 6, '2024-10-28 15:30:00'),
(2, 7, '2024-10-28 18:30:00'),
...
VALUES ('Squats', 'Legs', 'https://www.youtube.com/watch?v=U3HcD0PnczY'),
       ...
       ('Burpees', 'Full Body', 'https://www.youtube.com/watch?v=TU8QYVW0gDU'),
       ...
       ('High Knees', 'Cardio', 'https://www.youtube.com/watch?v=DfjpR6dzLVg'),
       ('Box Jumps', 'Legs', 'https://www.youtube.com/watch?v=W5QzqIbEWvk'),
       ...
       ('Snatches', 'Full Body', 'https://www.youtube.com/watch?v=GhxhiehJcQY'),
       ('Clean and Jerks', 'Full Body', 'https://www.youtube.com/watch?v=PjY1rH4_MOA'),
       ...
       ('Broad Jumps', 'Legs', 'https://www.youtube.com/watch?v=vPQv1gmrfUo'),
       ('Sled Drags', 'Full Body/Cardio', 'https://www.youtube.com/watch?v=fq2U2TSrN2U'),
       ('Jump Squats', 'Legs', 'https://www.youtube.com/watch?v=YGGq0AE5Uyc'),
       ('Battle Ropes', 'Full Body/Cardio', 'https://www.youtube.com/watch?v=zw0OMi00X5g'),
...
INSERT INTO week_metrics (number, client_id)
VALUES (1, 1),
       (2, 1),
       (1, 2),
       (2, 2),
...
-- Week 3 for Client 1
(2100, '2024-09-15', 6, 6.9, 9750, 73.6, 1, 15, 3),
(1900, '2024-09-16', 9, 7.5, 8000, 73.2, 1, 16, 3),
(2300, '2024-09-17', 10, 6.0, 7250, 73.0, 1, 17, 3),
(2400, '2024-09-18', 8, 7.0, 12000, 73.2, 1, 18, 3),
(1800, '2024-09-19', 3, 6.5, 13000, 73.2, 1, 19, 3),
(2200, '2024-09-20', 6, 7.8, 8500, 73.0, 1, 20, 3),
(2000, '2024-09-21', 5, 7.2, 9000, 73.1, 1, 21, 3),

-- Week 1 for Client 2
(1800, '2024-09-01', 7, 6.5, 7500, 80.0, 2, 22, 4),
(1700, '2024-09-02', 6, 5.0, 6000, 79.8, 2, 23, 4),
(1900, '2024-09-03', 8, 8.0, 9000, 79.6, 2, 24, 4),
(2100, '2024-09-04', 9, 7.2, 10000, 79.4, 2, 25, 4),
(2000, '2024-09-05', 7, 6.7, 8500, 79.2, 2, 26, 4),
(1800, '2024-09-06', 6, 6.0, 7000, 79.0, 2, 27, 4),
(2200, '2024-09-07', 9, 7.5, 11000, 78.8, 2, 28, 4),


-- Week 2 for Client 2
(2100, '2024-09-08', 7, 7.0, 9500, 78.6, 2, 29, 5),
(2000, '2024-09-09', 6, 6.5, 8500, 78.4, 2, 30, 5),
(2200, '2024-09-10', 8, 7.8, 10500, 78.2, 2, 31, 5),
(1900, '2024-09-11', 6, 6.0, 8000, 78.0, 2, 32, 5),
(2400, '2024-09-12', 9, 8.2, 12000, 77.8, 2, 33, 5),
(2300, '2024-09-13', 8, 7.2, 9500, 77.6, 2, 34, 5),
(2100, '2024-09-14', 7, 7.5, 10000, 77.4, 2, 35, 5),

-- Week 1 for Client 3
(2500, '2024-09-01', 9, 8.0, 12000, 65.0, 3, 36, 6),
(2400, '2024-09-02', 8, 7.0, 11000, 64.8, 3, 37, 6),
(2300, '2024-09-03', 7, 6.0, 10000, 64.6, 3, 38, 6),
(2200, '2024-09-04', 8, 7.5, 10500, 64.4, 3, 39, 6),
(2100, '2024-09-05', 7, 6.5, 9500, 64.2, 3, 40, 6),
(2300, '2024-09-06', 9, 7.8, 11500, 64.0, 3, 41, 6),
(2000, '2024-09-07', 7, 7.0, 9000, 63.8, 3, 42, 6),

-- Week 2 for Client 3
(2100, '2024-09-08', 8, 7.5, 9500, 63.6, 3, 43, 7),
(1900, '2024-09-09', 7, 6.5, 8500, 63.4, 3, 44, 7),
(2200, '2024-09-10', 9, 7.8, 11000, 63.2, 3, 45, 7),
(2000, '2024-09-11', 7, 7.0, 9000, 63.0, 3, 46, 7),
(2400, '2024-09-12', 8, 8.0, 11500, 62.8, 3, 47, 7),
(2300, '2024-09-13', 8, 7.2, 10000, 62.6, 3, 48, 7),
(2200, '2024-09-14', 7, 7.0, 9500, 62.4, 3, 49, 7),

-- Week 1 for Client 4
(2300, '2024-09-08', 8, 7.5, 9500, 60.5, 4, 50, 8),
(2500, '2024-09-09', 7, 6.5, 8500, 64.4, 4, 51, 8),
(2250, '2024-09-10', 9, 7.8, 11000, 63.2, 4, 52, 8),
(2000, '2024-09-11', 7, 7.0, 9000, 63.0, 4, 53, 8),
(2100, '2024-09-12', 8, 8.0, 11500, 62.8, 4, 54, 8),
(2400, '2024-09-13', 8, 7.2, 10000, 62.6, 4, 55, 8),
(2380, '2024-09-14', 7, 7.0, 9500, 62.4, 4, 56, 8),

-- Week 2 for Client 4
(2250, '2024-09-15', 8, 7.5, 9000, 70.0, 4, 57, 9),
(2275, '2024-09-16', 7, 6.5, 9100, 68.8, 4, 58, 9),
(2360, '2024-09-17', 9, 7.8, 10000, 65.7, 4, 59, 9),
(2370, '2024-09-18', 7, 7.0, 10500, 66.5, 4, 60, 9),
(2500, '2024-09-19', 8, 8.0, 8000, 67.0, 4, 61, 9),
(2100, '2024-09-20', 8, 7.2, 8500, 69.5, 4, 62, 9),
(2170, '2024-09-21', 7, 7.0, 9150, 69.7, 4, 63, 9);
